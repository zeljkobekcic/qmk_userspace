...
enum layers { BASE = 0, NAV, SYM, NUM };
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [NAV] = LAYOUT(
               KC_TAB,   TAB_LEFT_LINUX, TAB_RIGHT_LINUX, KC_NO,   KC_NO,   KC_NO,   KC_HOME, KC_END,  KC_BSPC, KC_DEL,
               _OS_SHFT, _OS_CTRL,       _OS_ALT,         _OS_GUI, KC_NO,   KC_NO,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT,
    ...
    [SYM] = LAYOUT(
        ...
        KC_NO, KC_UNDS, KC_ASTR, KC_AT,   KC_LBRC, KC_RBRC, KC_HASH, KC_AMPR, KC_SCLN, KC_COLN,  KC_EXLM,  KC_NO,
                                 KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
    ),

    [NUM] = LAYOUT(
               KC_1,     KC_2,     KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,     KC_9,     KC_0,
               _OS_SHFT, _OS_CTRL, _OS_ALT, _OS_GUI, KC_F11,  KC_F12,  _OS_GUI, _OS_RALT, _OS_CTRL, _OS_SHFT,
